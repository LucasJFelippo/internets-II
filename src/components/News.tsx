...
const News = ({ control }: ControlType) => {
    ...
    return (
        <div className="w-full h-screen flex justify-between bg-black border-t-2 border-white relative py-18 px-24">
            ...
            <div>
                ...
                <button className="bg-black text-white font-bold uppercase border border-white px-6 py-3 rounded-full mt-12 hover:bg-white hover:text-black">view all news</button>
            </div>
            <div>
